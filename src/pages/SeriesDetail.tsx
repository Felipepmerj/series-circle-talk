    ...
    try {
      ...
      if (watchlistId) {
        ...
        if (result) {
          ...
          toast({
            title: "Série salva!",
            description: "A série foi adicionada à sua lista de interesse com sucesso!",
          });
        } else {
          throw new Error("Falha ao salvar na watchlist");
        }
      }
      ...
      if (result) {
        ...
        throw new Error("Não foi possível salvar na watchlist");
      }
    } catch (error) {
      ...
      <Dialog open={showWatchlistDialog} onOpenChange={setShowWatchlistDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Adicione anotações sobre esta série (opcional)
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div>
              ...
              <Textarea 
                placeholder="O que você espera desta série..."
                value={watchlistNote}
            ...
            <Button onClick={handleAddToWatchlist} className="w-full">
              {watchlistId ? "Atualizar lista" : "Adicionar à lista"}
            </Button>
          </div>
        </DialogContent>
      </Dialog>
